...
void confPines(void)
{
  ...
  pinEINT0.Portnum = PINSEL_PORT_2; //SELECCION DE PUERTO 2
  pinEINT0.Pinnum = PINSEL_PIN_10; //SELECCION DE PIN 10
  ...
  pinEINT1.Portnum = PINSEL_PORT_2; //SELECCION DE PUERTO 2
  pinEINT1.Pinnum = PINSEL_PIN_11; //SELLECCION DE PIN 11
  ...
  pinEINT2.Portnum = PINSEL_PORT_2; //SELECCION DE PUERTO 2
  pinEINT2.Pinnum = PINSEL_PIN_12; //SELECCION DE PIN 12
  ...
  pinDAC.Portnum = PINSEL_PORT_0; //SELECCION DE PUERTO 0
  pinDAC.Pinnum = PINSEL_PIN_26; //SELECCION DE PIN 26
  pinDAC.Funcnum = PINSEL_FUNC_2; //FUNCION AOUT
  ...
  PINSEL_CFG_Type pinADC = {0}; // P0.23 AD0.0 FUNCION_1
  pinADC.Portnum = PINSEL_PORT_0; //SELECCION DE PUERTO 0
  pinADC.Pinnum = PINSEL_PIN_23; //SELECCION DE PIN 23
  pinADC.Funcnum = PINSEL_FUNC_1; //FUNCION AD0.0
  ...
  //CONFIGURAMOS TXD2 P0.10
  PINSEL_CFG_Type  pinTXD2 = {0};
  pinTXD2.Portnum = PINSEL_PORT_0; //SELECCION DE PUERTO 0
  pinTXD2.Pinnum = PINSEL_PIN_10; //SELECCION DE PIN 10
  pinTXD2.Funcnum = PINSEL_FUNC_1; //FUNCION TXD2
  ...
  pinRXD2.Portnum = PINSEL_PORT_0; //SELECCION DE PUERTO 0
  pinRXD2.Pinnum = PINSEL_PIN_11; //SELECCION DE PIN 11
  pinRXD2.Funcnum = PINSEL_FUNC_1; //FUNCION RXD2
